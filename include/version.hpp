/**
 * Current version of the clion-bug application.
 *
 ...
 */
#ifndef CLION_BUG_VERSION_HPP
#define CLION_BUG_VERSION_HPP

#define CLION_BUG_VERSION "0.1.0.0"

#endif  // CLION_BUG_VERSION_HPP
